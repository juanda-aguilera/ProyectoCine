...
public class Venta {
    ...
    // Metodo de comportamiento: calcula el subtotal (precio x cantidad)
    public double calcularSubtotal() {
        this.subtotal = this.precio * this.cantidad;
        return this.subtotal;
    }

    // Metodo de comportamiento: calcula el descuento segun la membresia del cliente
    public double calcularDescuento() {
        this.descuento = cliente.calcularDescuento(tipoVenta, this.subtotal);
        return this.descuento;
    }

    // Metodo de comportamiento: calcula el total final de la venta
